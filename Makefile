...
KIND_CLUSTER ?= platform-operator-blueprint-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name platform-operator-blueprint-builder
	$(CONTAINER_TOOL) buildx use platform-operator-blueprint-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm platform-operator-blueprint-builder
	rm Dockerfile.cross
